...
if [ ${BENCH_NAME} = "EP" ] 
	...
	then
			for ((i=1; i<=${N_ITER}; i++))
				do
					...
					${CETUS} -alias=0 lu.c read_input.c domain.c setcoeff.c setbv.c exact.c setiv.c erhs.c ssor.c rhs.c l2norm.c jacld.c blts.c jacu.c buts.c error.c pintgr.c verify.c ../common/print_results.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}.c
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS} -alias=1 lu.c read_input.c domain.c setcoeff.c setbv.c exact.c setiv.c erhs.c ssor.c rhs.c l2norm.c jacld.c blts.c jacu.c buts.c error.c pintgr.c verify.c ../common/print_results.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}.c
					cp cetus_output/read_input.c cetus_read_input.c
					cp cetus_output/domain.c cetus_domain.c
					cp cetus_output/setcoeff.c cetus_setcoeff.c
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS} -alias=3 lu.c read_input.c domain.c setcoeff.c setbv.c exact.c setiv.c erhs.c ssor.c rhs.c l2norm.c jacld.c blts.c jacu.c buts.c error.c pintgr.c verify.c ../common/print_results.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}.c
					cp cetus_output/read_input.c cetus_read_input.c
					cp cetus_output/domain.c cetus_domain.c
					cp cetus_output/setcoeff.c cetus_setcoeff.c
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS} -ddt=0 lu.c read_input.c domain.c setcoeff.c setbv.c exact.c setiv.c erhs.c ssor.c rhs.c l2norm.c jacld.c blts.c jacu.c buts.c error.c pintgr.c verify.c ../common/print_results.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}.c
					cp cetus_output/read_input.c cetus_read_input.c
					cp cetus_output/domain.c cetus_domain.c
					cp cetus_output/setcoeff.c cetus_setcoeff.c
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS} -ddt=1 lu.c read_input.c domain.c setcoeff.c setbv.c exact.c setiv.c erhs.c ssor.c rhs.c l2norm.c jacld.c blts.c jacu.c buts.c error.c pintgr.c verify.c ../common/print_results.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}.c
					cp cetus_output/read_input.c cetus_read_input.c
					cp cetus_output/domain.c cetus_domain.c
					cp cetus_output/setcoeff.c cetus_setcoeff.c
			...
			for ((i=1; i<=${N_ITER}; i++))
				do  
					${CETUS} -ddt=2 lu.c read_input.c domain.c setcoeff.c setbv.c exact.c setiv.c erhs.c ssor.c rhs.c l2norm.c jacld.c blts.c jacu.c buts.c error.c pintgr.c verify.c ../common/print_results.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}.c
					cp cetus_output/read_input.c cetus_read_input.c
					cp cetus_output/domain.c cetus_domain.c
					cp cetus_output/setcoeff.c cetus_setcoeff.c
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS} -parallelize-loops=0 lu.c read_input.c domain.c setcoeff.c setbv.c exact.c setiv.c erhs.c ssor.c rhs.c l2norm.c jacld.c blts.c jacu.c buts.c error.c pintgr.c verify.c ../common/print_results.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}.c
					cp cetus_output/read_input.c cetus_read_input.c
					cp cetus_output/domain.c cetus_domain.c
					cp cetus_output/setcoeff.c cetus_setcoeff.c
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS} -parallelize-loops=1 lu.c read_input.c domain.c setcoeff.c setbv.c exact.c setiv.c erhs.c ssor.c rhs.c l2norm.c jacld.c blts.c jacu.c buts.c error.c pintgr.c verify.c ../common/print_results.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}.c
					cp cetus_output/read_input.c cetus_read_input.c
					cp cetus_output/domain.c cetus_domain.c
					cp cetus_output/setcoeff.c cetus_setcoeff.c
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS} -privatize=0  lu.c read_input.c domain.c setcoeff.c setbv.c exact.c setiv.c erhs.c ssor.c rhs.c l2norm.c jacld.c blts.c jacu.c buts.c error.c pintgr.c verify.c ../common/print_results.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}.c
					cp cetus_output/read_input.c cetus_read_input.c
					cp cetus_output/domain.c cetus_domain.c
					cp cetus_output/setcoeff.c cetus_setcoeff.c
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS} -privatize=1 lu.c read_input.c domain.c setcoeff.c setbv.c exact.c setiv.c erhs.c ssor.c rhs.c l2norm.c jacld.c blts.c jacu.c buts.c error.c pintgr.c verify.c ../common/print_results.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}.c
					cp cetus_output/read_input.c cetus_read_input.c
					cp cetus_output/domain.c cetus_domain.c
					cp cetus_output/setcoeff.c cetus_setcoeff.c
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS} -privatize=2 lu.c read_input.c domain.c setcoeff.c setbv.c exact.c setiv.c erhs.c ssor.c rhs.c l2norm.c jacld.c blts.c jacu.c buts.c error.c pintgr.c verify.c ../common/print_results.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}.c
					cp cetus_output/read_input.c cetus_read_input.c
					cp cetus_output/domain.c cetus_domain.c
					cp cetus_output/setcoeff.c cetus_setcoeff.c
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS} -range=0 lu.c read_input.c domain.c setcoeff.c setbv.c exact.c setiv.c erhs.c ssor.c rhs.c l2norm.c jacld.c blts.c jacu.c buts.c error.c pintgr.c verify.c ../common/print_results.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}.c
					cp cetus_output/read_input.c cetus_read_input.c
					cp cetus_output/domain.c cetus_domain.c
					cp cetus_output/setcoeff.c cetus_setcoeff.c
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS} -range=1 lu.c read_input.c domain.c setcoeff.c setbv.c exact.c setiv.c erhs.c ssor.c rhs.c l2norm.c jacld.c blts.c jacu.c buts.c error.c pintgr.c verify.c ../common/print_results.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}.c
					cp cetus_output/read_input.c cetus_read_input.c
					cp cetus_output/domain.c cetus_domain.c
					cp cetus_output/setcoeff.c cetus_setcoeff.c
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS} -range=2 lu.c read_input.c domain.c setcoeff.c setbv.c exact.c setiv.c erhs.c ssor.c rhs.c l2norm.c jacld.c blts.c jacu.c buts.c error.c pintgr.c verify.c ../common/print_results.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}.c
					cp cetus_output/read_input.c cetus_read_input.c
					cp cetus_output/domain.c cetus_domain.c
					cp cetus_output/setcoeff.c cetus_setcoeff.c
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS} -reduction=0 lu.c read_input.c domain.c setcoeff.c setbv.c exact.c setiv.c erhs.c ssor.c rhs.c l2norm.c jacld.c blts.c jacu.c buts.c error.c pintgr.c verify.c ../common/print_results.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}.c
					cp cetus_output/read_input.c cetus_read_input.c
					cp cetus_output/domain.c cetus_domain.c
					cp cetus_output/setcoeff.c cetus_setcoeff.c
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS} -reduction=1 lu.c read_input.c domain.c setcoeff.c setbv.c exact.c setiv.c erhs.c ssor.c rhs.c l2norm.c jacld.c blts.c jacu.c buts.c error.c pintgr.c verify.c ../common/print_results.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}.c
					cp cetus_output/read_input.c cetus_read_input.c
					cp cetus_output/domain.c cetus_domain.c
					cp cetus_output/setcoeff.c cetus_setcoeff.c
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
				${CETUS} -reduction=2 lu.c read_input.c domain.c setcoeff.c setbv.c exact.c setiv.c erhs.c ssor.c rhs.c l2norm.c jacld.c blts.c jacu.c buts.c error.c pintgr.c verify.c ../common/print_results.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}.c
					cp cetus_output/read_input.c cetus_read_input.c
					cp cetus_output/domain.c cetus_domain.c
					cp cetus_output/setcoeff.c cetus_setcoeff.c
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS} -induction=0 lu.c read_input.c domain.c setcoeff.c setbv.c exact.c setiv.c erhs.c ssor.c rhs.c l2norm.c jacld.c blts.c jacu.c buts.c error.c pintgr.c verify.c ../common/print_results.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}.c
					cp cetus_output/read_input.c cetus_read_input.c
					cp cetus_output/domain.c cetus_domain.c
					cp cetus_output/setcoeff.c cetus_setcoeff.c
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS} -induction=1 lu.c read_input.c domain.c setcoeff.c setbv.c exact.c setiv.c erhs.c ssor.c rhs.c l2norm.c jacld.c blts.c jacu.c buts.c error.c pintgr.c verify.c ../common/print_results.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}.c
					cp cetus_output/read_input.c cetus_read_input.c
					cp cetus_output/domain.c cetus_domain.c
					cp cetus_output/setcoeff.c cetus_setcoeff.c
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS} -induction=2 -lu.c read_input.c domain.c setcoeff.c setbv.c exact.c setiv.c erhs.c ssor.c rhs.c l2norm.c jacld.c blts.c jacu.c buts.c error.c pintgr.c verify.c ../common/print_results.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}.c
					cp cetus_output/read_input.c cetus_read_input.c
					cp cetus_output/domain.c cetus_domain.c
					cp cetus_output/setcoeff.c cetus_setcoeff.c
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS} -induction=3 lu.c read_input.c domain.c setcoeff.c setbv.c exact.c setiv.c erhs.c ssor.c rhs.c l2norm.c jacld.c blts.c jacu.c buts.c error.c pintgr.c verify.c ../common/print_results.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}.c
					cp cetus_output/read_input.c cetus_read_input.c
					cp cetus_output/domain.c cetus_domain.c
					cp cetus_output/setcoeff.c cetus_setcoeff.c
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS} -normalize-loops=0 lu.c read_input.c domain.c setcoeff.c setbv.c exact.c setiv.c erhs.c ssor.c rhs.c l2norm.c jacld.c blts.c jacu.c buts.c error.c pintgr.c verify.c ../common/print_results.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}.c
					cp cetus_output/read_input.c cetus_read_input.c
					cp cetus_output/domain.c cetus_domain.c
					cp cetus_output/setcoeff.c cetus_setcoeff.c
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS} -normalize-loops=1 lu.c read_input.c domain.c setcoeff.c setbv.c exact.c setiv.c erhs.c ssor.c rhs.c l2norm.c jacld.c blts.c jacu.c buts.c error.c pintgr.c verify.c ../common/print_results.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}.c
					cp cetus_output/read_input.c cetus_read_input.c
					cp cetus_output/domain.c cetus_domain.c
					cp cetus_output/setcoeff.c cetus_setcoeff.c
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS} -profitable-omp=0 lu.c read_input.c domain.c setcoeff.c setbv.c exact.c setiv.c erhs.c ssor.c rhs.c l2norm.c jacld.c blts.c jacu.c buts.c error.c pintgr.c verify.c ../common/print_results.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}.c
					cp cetus_output/read_input.c cetus_read_input.c
					cp cetus_output/domain.c cetus_domain.c
					cp cetus_output/setcoeff.c cetus_setcoeff.c
	...
	then	
			${CETUS} add.c adi.c error.c exact_rhs.c exact_solution.c initialize.c ninvr.c pinvr.c rhs.c set_constants.c sp.c txinvr.c tzetar.c verify.c x_solve.c y_solve.c z_solve.c ../common/print_results.c  ../common/randdp.c ../common/c_timers.c ../common/wtime.c
			cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}.c
			cp cetus_output/add.c cetus_add.c
			cp cetus_output/adi.c cetus_adi.c
			cp cetus_output/error.c cetus_error.c
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS} -alias=0 add.c adi.c error.c exact_rhs.c exact_solution.c initialize.c ninvr.c pinvr.c rhs.c set_constants.c sp.c txinvr.c tzetar.c verify.c x_solve.c y_solve.c z_solve.c ../common/print_results.c ../common/randdp.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}.c
					cp cetus_output/add.c cetus_add.c
					cp cetus_output/adi.c cetus_adi.c
					cp cetus_output/error.c cetus_error.c
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS}  -alias=1 add.c adi.c error.c exact_rhs.c exact_solution.c initialize.c ninvr.c pinvr.c rhs.c set_constants.c sp.c txinvr.c tzetar.c verify.c x_solve.c y_solve.c z_solve.c ../common/print_results.c ../common/randdp.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}.c
					cp cetus_output/add.c cetus_add.c
					cp cetus_output/adi.c cetus_adi.c
					cp cetus_output/error.c cetus_error.c
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS}  -alias=3 add.c adi.c error.c exact_rhs.c exact_solution.c initialize.c ninvr.c pinvr.c rhs.c set_constants.c sp.c txinvr.c tzetar.c verify.c x_solve.c y_solve.c z_solve.c ../common/print_results.c ../common/randdp.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}.c
					cp cetus_output/add.c cetus_add.c
					cp cetus_output/adi.c cetus_adi.c
					cp cetus_output/error.c cetus_error.c
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS}  -ddt=0 add.c adi.c error.c exact_rhs.c exact_solution.c initialize.c ninvr.c pinvr.c rhs.c set_constants.c sp.c txinvr.c tzetar.c verify.c x_solve.c y_solve.c z_solve.c ../common/print_results.c ../common/randdp.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}.c
					cp cetus_output/add.c cetus_add.c
					cp cetus_output/adi.c cetus_adi.c
					cp cetus_output/error.c cetus_error.c
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS}  -ddt=1 add.c adi.c error.c exact_rhs.c exact_solution.c initialize.c ninvr.c pinvr.c rhs.c set_constants.c sp.c txinvr.c tzetar.c verify.c x_solve.c y_solve.c z_solve.c ../common/print_results.c ../common/randdp.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}.c
					cp cetus_output/add.c cetus_add.c
					cp cetus_output/adi.c cetus_adi.c
					cp cetus_output/error.c cetus_error.c
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS}  -ddt=2 add.c adi.c error.c exact_rhs.c exact_solution.c initialize.c ninvr.c pinvr.c rhs.c set_constants.c sp.c txinvr.c tzetar.c verify.c x_solve.c y_solve.c z_solve.c ../common/print_results.c ../common/randdp.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}.c
					cp cetus_output/add.c cetus_add.c
					cp cetus_output/adi.c cetus_adi.c
					cp cetus_output/error.c cetus_error.c
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS}  -parallelize-loops=0 add.c adi.c error.c exact_rhs.c exact_solution.c initialize.c ninvr.c pinvr.c rhs.c set_constants.c sp.c txinvr.c tzetar.c verify.c x_solve.c y_solve.c z_solve.c ../common/print_results.c ../common/randdp.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}.c
					cp cetus_output/add.c cetus_add.c
					cp cetus_output/adi.c cetus_adi.c
					cp cetus_output/error.c cetus_error.c
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS}  -parallelize-loops=1 add.c adi.c error.c exact_rhs.c exact_solution.c initialize.c ninvr.c pinvr.c rhs.c set_constants.c sp.c txinvr.c tzetar.c verify.c x_solve.c y_solve.c z_solve.c ../common/print_results.c ../common/randdp.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}.c
					cp cetus_output/add.c cetus_add.c
					cp cetus_output/adi.c cetus_adi.c
					cp cetus_output/error.c cetus_error.c
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS}  -privatize=0 add.c adi.c error.c exact_rhs.c exact_solution.c initialize.c ninvr.c pinvr.c rhs.c set_constants.c sp.c txinvr.c tzetar.c verify.c x_solve.c y_solve.c z_solve.c ../common/print_results.c ../common/randdp.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}.c
					cp cetus_output/add.c cetus_add.c
					cp cetus_output/adi.c cetus_adi.c
					cp cetus_output/error.c cetus_error.c
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS}  -privatize=1 add.c adi.c error.c exact_rhs.c exact_solution.c initialize.c ninvr.c pinvr.c rhs.c set_constants.c sp.c txinvr.c tzetar.c verify.c x_solve.c y_solve.c z_solve.c ../common/print_results.c ../common/randdp.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}.c
					cp cetus_output/add.c cetus_add.c
					cp cetus_output/adi.c cetus_adi.c
					cp cetus_output/error.c cetus_error.c
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS}  -privatize=2 add.c adi.c error.c exact_rhs.c exact_solution.c initialize.c ninvr.c pinvr.c rhs.c set_constants.c sp.c txinvr.c tzetar.c verify.c x_solve.c y_solve.c z_solve.c ../common/print_results.c ../common/randdp.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}.c
					cp cetus_output/add.c cetus_add.c
					cp cetus_output/adi.c cetus_adi.c
					cp cetus_output/error.c cetus_error.c
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS}  -range=0 add.c adi.c error.c exact_rhs.c exact_solution.c initialize.c ninvr.c pinvr.c rhs.c set_constants.c sp.c txinvr.c tzetar.c verify.c x_solve.c y_solve.c z_solve.c ../common/print_results.c ../common/randdp.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}.c
					cp cetus_output/add.c cetus_add.c
					cp cetus_output/adi.c cetus_adi.c
					cp cetus_output/error.c cetus_error.c
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS}  -range=1 add.c adi.c error.c exact_rhs.c exact_solution.c initialize.c ninvr.c pinvr.c rhs.c set_constants.c sp.c txinvr.c tzetar.c verify.c x_solve.c y_solve.c z_solve.c ../common/print_results.c ../common/randdp.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}.c
					cp cetus_output/add.c cetus_add.c
					cp cetus_output/adi.c cetus_adi.c
					cp cetus_output/error.c cetus_error.c
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS} -range=2 add.c adi.c error.c exact_rhs.c exact_solution.c initialize.c ninvr.c pinvr.c rhs.c set_constants.c sp.c txinvr.c tzetar.c verify.c x_solve.c y_solve.c z_solve.c ../common/print_results.c ../common/randdp.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}.c
					cp cetus_output/add.c cetus_add.c
					cp cetus_output/adi.c cetus_adi.c
					cp cetus_output/error.c cetus_error.c
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS}  -reduction=0 add.c adi.c error.c exact_rhs.c exact_solution.c initialize.c ninvr.c pinvr.c rhs.c set_constants.c sp.c txinvr.c tzetar.c verify.c x_solve.c y_solve.c z_solve.c ../common/print_results.c ../common/randdp.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}.c
					cp cetus_output/add.c cetus_add.c
					cp cetus_output/adi.c cetus_adi.c
					cp cetus_output/error.c cetus_error.c
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS} -reduction=1 add.c adi.c error.c exact_rhs.c exact_solution.c initialize.c ninvr.c pinvr.c rhs.c set_constants.c sp.c txinvr.c tzetar.c verify.c x_solve.c y_solve.c z_solve.c ../common/print_results.c ../common/randdp.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}.c
					cp cetus_output/add.c cetus_add.c
					cp cetus_output/adi.c cetus_adi.c
					cp cetus_output/error.c cetus_error.c
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS} -reduction=2 add.c adi.c error.c exact_rhs.c exact_solution.c initialize.c ninvr.c pinvr.c rhs.c set_constants.c sp.c txinvr.c tzetar.c verify.c x_solve.c y_solve.c z_solve.c ../common/print_results.c ../common/randdp.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}.c
					cp cetus_output/add.c cetus_add.c
					cp cetus_output/adi.c cetus_adi.c
					cp cetus_output/error.c cetus_error.c
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS} -induction=0 add.c adi.c error.c exact_rhs.c exact_solution.c initialize.c ninvr.c pinvr.c rhs.c set_constants.c sp.c txinvr.c tzetar.c verify.c x_solve.c y_solve.c z_solve.c ../common/print_results.c ../common/randdp.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}.c
					cp cetus_output/add.c cetus_add.c
					cp cetus_output/adi.c cetus_adi.c
					cp cetus_output/error.c cetus_error.c
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS} -induction=1 add.c adi.c error.c exact_rhs.c exact_solution.c initialize.c ninvr.c pinvr.c rhs.c set_constants.c sp.c txinvr.c tzetar.c verify.c x_solve.c y_solve.c z_solve.c ../common/print_results.c ../common/randdp.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}.c
					cp cetus_output/add.c cetus_add.c
					cp cetus_output/adi.c cetus_adi.c
					cp cetus_output/error.c cetus_error.c
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS} -induction=2 add.c adi.c error.c exact_rhs.c exact_solution.c initialize.c ninvr.c pinvr.c rhs.c set_constants.c sp.c txinvr.c tzetar.c verify.c x_solve.c y_solve.c z_solve.c ../common/print_results.c ../common/randdp.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}.c
					cp cetus_output/add.c cetus_add.c
					cp cetus_output/adi.c cetus_adi.c
					cp cetus_output/error.c cetus_error.c
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS} -induction=3 add.c adi.c error.c exact_rhs.c exact_solution.c initialize.c ninvr.c pinvr.c rhs.c set_constants.c sp.c txinvr.c tzetar.c verify.c x_solve.c y_solve.c z_solve.c ../common/print_results.c ../common/randdp.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}.c
					cp cetus_output/add.c cetus_add.c
					cp cetus_output/adi.c cetus_adi.c
					cp cetus_output/error.c cetus_error.c
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS} -normalize-loops=0 add.c adi.c error.c exact_rhs.c exact_solution.c initialize.c ninvr.c pinvr.c rhs.c set_constants.c sp.c txinvr.c tzetar.c verify.c x_solve.c y_solve.c z_solve.c ../common/print_results.c ../common/randdp.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}.c
					cp cetus_output/add.c cetus_add.c
					cp cetus_output/adi.c cetus_adi.c
					cp cetus_output/error.c cetus_error.c
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS} -normalize-loops=1 add.c adi.c error.c exact_rhs.c exact_solution.c initialize.c ninvr.c pinvr.c rhs.c set_constants.c sp.c txinvr.c tzetar.c verify.c x_solve.c y_solve.c z_solve.c ../common/print_results.c ../common/randdp.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}.c
					cp cetus_output/add.c cetus_add.c
					cp cetus_output/adi.c cetus_adi.c
					cp cetus_output/error.c cetus_error.c
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS} -profitable-omp=0 add.c adi.c error.c exact_rhs.c exact_solution.c initialize.c ninvr.c pinvr.c rhs.c set_constants.c sp.c txinvr.c tzetar.c verify.c x_solve.c y_solve.c z_solve.c ../common/print_results.c ../common/randdp.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}.c
					cp cetus_output/add.c cetus_add.c
					cp cetus_output/adi.c cetus_adi.c
					cp cetus_output/error.c cetus_error.c
					...
					#sed -i 's+/\* #include <math.h> \*/+#include <math.h>+' ./cetus_${FILE_NAME}.c
					gcc -O3 -fopenmp -mcmodel=large -o output cetus_add.c cetus_adi.c cetus_error.c cetus_exact_rhs.c cetus_exact_solution.c cetus_initialize.c cetus_ninvr.c  cetus_pinvr.c cetus_rhs.c cetus_set_constants.c cetus_sp.c cetus_txinvr.c cetus_tzetar.c cetus_verify.c cetus_x_solve.c cetus_y_solve.c cetus_z_solve.c  ../common/print_results.c ../common/randdp.c ../common/c_timers.c ../common/wtime.c -lm
					mv output output${BENCH_CLASS}/cetus_${FILE_NAME}_-profitable-omp=0_${i}
					echo "<----------------------------->"
				done
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS} -profitable-omp=1 add.c adi.c error.c exact_rhs.c exact_solution.c initialize.c ninvr.c pinvr.c rhs.c set_constants.c sp.c txinvr.c tzetar.c verify.c x_solve.c y_solve.c z_solve.c ../common/print_results.c ../common/randdp.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}.c
					cp cetus_output/add.c cetus_add.c
					cp cetus_output/adi.c cetus_adi.c
					cp cetus_output/error.c cetus_error.c
					...
					#sed -i 's+/\* #include <math.h> \*/+#include <math.h>+' ./cetus_${FILE_NAME}.c
					gcc -O3 -fopenmp -mcmodel=large -o output cetus_add.c cetus_adi.c cetus_error.c cetus_exact_rhs.c cetus_exact_solution.c cetus_initialize.c cetus_ninvr.c  cetus_pinvr.c cetus_rhs.c cetus_set_constants.c cetus_sp.c cetus_txinvr.c cetus_tzetar.c cetus_verify.c cetus_x_solve.c cetus_y_solve.c cetus_z_solve.c  ../common/print_results.c ../common/randdp.c ../common/c_timers.c ../common/wtime.c -lm
					mv output output${BENCH_CLASS}/cetus_${FILE_NAME}_-profitable-omp=1_${i}
					echo "<----------------------------->"
				done																										
	...
	then
			    ...
			    gcc  -O3 -mcmodel=large -o outputSerial  adc.c dc.c extbuild.c jobcntl.c rbt.c -lm
				echo "<----------------------------->"	

				${CETUS} -alias=2 -ddt=2 -parallelize-loops=1 -privatize=1 -range=1 -reduction=2 dc.c adc.c extbuild.c jobcntl.c rbt.c
				cp cetus_output/dc.c cetus_dc.c
				...
				cp cetus_output/rbt.c cetus_rbt.c	
			  	gcc  -O3 -fopenmp -mcmodel=large -o ddc-Scalarprivatization-on cetus_adc.c cetus_dc.c cetus_extbuild.c cetus_jobcntl.c cetus_rbt.c -lm
				echo "<----------------------------->"	

				${CETUS} -alias=2 -ddt=2 -parallelize-loops=1 -privatize=0 -range=1 -reduction=2 dc.c adc.c extbuild.c jobcntl.c rbt.c
				cp cetus_output/dc.c cetus_dc.c
				cp cetus_output/adc.c cetus_adc.c
				cp cetus_output/extbuild.c cetus_extbuild.c
				cp cetus_output/jobcntl.c cetus_jobcntl.c
				cp cetus_output/rbt.c cetus_rbt.c	
			  	gcc  -O3 -fopenmp -mcmodel=large -o ddc-privatization-off cetus_adc.c cetus_dc.c cetus_extbuild.c cetus_jobcntl.c cetus_rbt.c -lm
				echo "<----------------------------->"
			
				${CETUS} -alias=2  -ddt=2 -parallelize-loops=1 -privatize=2 -range=1 -reduction=2 dc.c adc.c extbuild.c jobcntl.c rbt.c
				cp cetus_output/dc.c cetus_dc.c
				cp cetus_output/adc.c cetus_adc.c
				cp cetus_output/extbuild.c cetus_extbuild.c
				cp cetus_output/jobcntl.c cetus_jobcntl.c
				cp cetus_output/rbt.c cetus_rbt.c	
			    gcc  -O3 -fopenmp -mcmodel=large -o ddc-Interrange-on cetus_adc.c cetus_dc.c cetus_extbuild.c cetus_jobcntl.c cetus_rbt.c -lm
				echo "<----------------------------->"	
				
				${CETUS} -alias=2  -ddt=2 -parallelize-loops=1 -privatize=2 -range=0 -reduction=2 dc.c adc.c extbuild.c jobcntl.c rbt.c
				cp cetus_output/dc.c cetus_dc.c
				cp cetus_output/adc.c cetus_adc.c
				cp cetus_output/extbuild.c cetus_extbuild.c
				cp cetus_output/jobcntl.c cetus_jobcntl.c
				cp cetus_output/rbt.c cetus_rbt.c	
			    gcc  -O3 -fopenmp -mcmodel=large -o ddc-range-off cetus_adc.c cetus_dc.c cetus_extbuild.c cetus_jobcntl.c cetus_rbt.c -lm
				echo "<----------------------------->"	
		
		
				${CETUS} -alias=2 -ddt=2 -parallelize-loops=1 -privatize=2 -range=1 -reduction=1 dc.c adc.c extbuild.c jobcntl.c rbt.c 
				cp cetus_output/dc.c cetus_dc.c
				cp cetus_output/adc.c cetus_adc.c
				cp cetus_output/extbuild.c cetus_extbuild.c
				cp cetus_output/jobcntl.c cetus_jobcntl.c
				cp cetus_output/rbt.c cetus_rbt.c
		    	gcc  -O3 -fopenmp -mcmodel=large -o ddc-Scalarreduction-on cetus_adc.c cetus_dc.c cetus_extbuild.c cetus_jobcntl.c cetus_rbt.c -lm
				echo "<----------------------------->"

				${CETUS} -alias=2 -ddt=2 -parallelize-loops=1 -privatize=2 -range=1 -reduction=0 dc.c adc.c extbuild.c jobcntl.c rbt.c
				cp cetus_output/dc.c cetus_dc.c
				cp cetus_output/adc.c cetus_adc.c
				cp cetus_output/extbuild.c cetus_extbuild.c
				cp cetus_output/jobcntl.c cetus_jobcntl.c
				cp cetus_output/rbt.c cetus_rbt.c
		    	gcc  -O3 -fopenmp -mcmodel=large -o ddc-reduction-off cetus_adc.c cetus_dc.c cetus_extbuild.c cetus_jobcntl.c cetus_rbt.c -lm
				echo "<----------------------------->"
		...
		then
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS} -alias=0 ${FILE_NAME}.c ../common/print_results.c ../common/randdp.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}_alias=0_${i}.c
					#sed -i 's+/\* #include <math.h> \*/+#include <math.h>+' ./cetus_${FILE_NAME}.c
					#gcc -fopenmp -o output ./cetus_${FILE_NAME}.c -lm
					#mv output output${BENCH_CLASS}/cetus_${FILE_NAME}_alias=0_${i}
					echo "<----------------------------->"
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS} -alias=1 ${FILE_NAME}.c ../common/print_results.c ../common/randdp.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}_alias=1_${i}.c
					#sed -i 's+/\* #include <math.h> \*/+#include <math.h>+' ./cetus_${FILE_NAME}.c
					#gcc -fopenmp -o output ./cetus_${FILE_NAME}.c -lm
					#mv output output${BENCH_CLASS}/cetus_${FILE_NAME}_alias=1_${i}
					echo "<----------------------------->"
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS} -alias=3 ${FILE_NAME}.c ../common/print_results.c ../common/randdp.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}_alias=3_${i}.c
					#sed -i 's+/\* #include <math.h> \*/+#include <math.h>+' ./cetus_${FILE_NAME}.c
					#gcc -fopenmp -o output ./cetus_${FILE_NAME}.c -lm
					#mv output output${BENCH_CLASS}/cetus_${FILE_NAME}_alias=3_${i}
					echo "<----------------------------->"
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS} -ddt=0 ${FILE_NAME}.c ../common/print_results.c ../common/randdp.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}_ddt=0_${i}.c
					#sed -i 's+/\* #include <math.h> \*/+#include <math.h>+' ./cetus_${FILE_NAME}.c
					#gcc -fopenmp -o output ./cetus_${FILE_NAME}.c -lm
					#mv output output${BENCH_CLASS}/cetus_${FILE_NAME}_ddt=0_${i}
					echo "<----------------------------->"
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS} -ddt=1 ${FILE_NAME}.c ../common/print_results.c ../common/randdp.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}_ddt=1_${i}.c
					#sed -i 's+/\* #include <math.h> \*/+#include <math.h>+' ./cetus_${FILE_NAME}.c
					#gcc -fopenmp -o output ./cetus_${FILE_NAME}.c -lm
					#mv output output${BENCH_CLASS}/cetus_${FILE_NAME}_ddt=1_${i}
					echo "<----------------------------->"
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS} -ddt=2 ${FILE_NAME}.c ../common/print_results.c ../common/randdp.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}_ddt=2_${i}.c
					#sed -i 's+/\* #include <math.h> \*/+#include <math.h>+' ./cetus_${FILE_NAME}.c
					#gcc -fopenmp -o output ./cetus_${FILE_NAME}.c -lm
					#mv output output${BENCH_CLASS}/cetus_${FILE_NAME}_ddt=2_${i}
					echo "<----------------------------->"
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS} -parallelize-loops=0 ${FILE_NAME}.c ../common/print_results.c ../common/randdp.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}_parallelize-loops=0_${i}.c
					#sed -i 's+/\* #include <math.h> \*/+#include <math.h>+' ./cetus_${FILE_NAME}.c
					#gcc -fopenmp -o output ./cetus_${FILE_NAME}.c -lm
					#mv output output${BENCH_CLASS}/cetus_${FILE_NAME}_parallelize-loops=0_${i}
					echo "<----------------------------->"
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS} -parallelize-loops=1 ${FILE_NAME}.c ../common/print_results.c ../common/randdp.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}_parallelize-loops=1_${i}.c
					#sed -i 's+/\* #include <math.h> \*/+#include <math.h>+' ./cetus_${FILE_NAME}.c
					#gcc -fopenmp -o output ./cetus_${FILE_NAME}.c -lm
					#mv output output${BENCH_CLASS}/cetus_${FILE_NAME}_parallelize-loops=1_${i}
					echo "<----------------------------->"
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS} -privatize=0 ${FILE_NAME}.c ../common/print_results.c ../common/randdp.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}_privatize=0_${i}.c
					#sed -i 's+/\* #include <math.h> \*/+#include <math.h>+' ./cetus_${FILE_NAME}.c
					#gcc -fopenmp -o output ./cetus_${FILE_NAME}.c -lm
					#mv output output${BENCH_CLASS}/cetus_${FILE_NAME}_privatize=0_${i}
					echo "<----------------------------->"
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS} -privatize=1 ${FILE_NAME}.c ../common/print_results.c ../common/randdp.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}_privatize=1_${i}.c
					#sed -i 's+/\* #include <math.h> \*/+#include <math.h>+' ./cetus_${FILE_NAME}.c
					#gcc -fopenmp -o output ./cetus_${FILE_NAME}.c -lm
					#mv output output${BENCH_CLASS}/cetus_${FILE_NAME}_privatize=1_${i}
					echo "<----------------------------->"
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS} -privatize=2 ${FILE_NAME}.c ../common/print_results.c ../common/randdp.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}_privatize=2_${i}.c
					#sed -i 's+/\* #include <math.h> \*/+#include <math.h>+' ./cetus_${FILE_NAME}.c
					#gcc -fopenmp -o output ./cetus_${FILE_NAME}.c -lm
					#mv output output${BENCH_CLASS}/cetus_${FILE_NAME}_privatize=2_${i}
					echo "<----------------------------->"
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS} -range=0 ${FILE_NAME}.c ../common/print_results.c ../common/randdp.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}_range=0_${i}.c
					#sed -i 's+/\* #include <math.h> \*/+#include <math.h>+' ./cetus_${FILE_NAME}.c
					#gcc -fopenmp -o output ./cetus_${FILE_NAME}.c -lm
					#mv output output${BENCH_CLASS}/cetus_${FILE_NAME}_range=0_${i}
					echo "<----------------------------->"
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS} -range=1 ${FILE_NAME}.c ../common/print_results.c ../common/randdp.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}_range=1_${i}.c
					#sed -i 's+/\* #include <math.h> \*/+#include <math.h>+' ./cetus_${FILE_NAME}.c
					#gcc -fopenmp -o output ./cetus_${FILE_NAME}.c -lm
					#mv output output${BENCH_CLASS}/cetus_${FILE_NAME}_range=1_${i}
					echo "<----------------------------->"
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS} -range=2 ${FILE_NAME}.c ../common/print_results.c ../common/randdp.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}_range=2_${i}.c
					#sed -i 's+/\* #include <math.h> \*/+#include <math.h>+' ./cetus_${FILE_NAME}.c
					#gcc -fopenmp -o output ./cetus_${FILE_NAME}.c -lm
					#mv output output${BENCH_CLASS}/cetus_${FILE_NAME}_range=2_${i}
					echo "<----------------------------->"
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS} -reduction=0 ${FILE_NAME}.c ../common/print_results.c ../common/randdp.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}_reduction=0_${i}.c
					#sed -i 's+/\* #include <math.h> \*/+#include <math.h>+' ./cetus_${FILE_NAME}.c
					#gcc -fopenmp -o output ./cetus_${FILE_NAME}.c -lm
					#mv output output${BENCH_CLASS}/cetus_${FILE_NAME}_reduction=0_${i}
					echo "<----------------------------->"
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS} -reduction=1 ${FILE_NAME}.c ../common/print_results.c ../common/randdp.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}_reduction=1_${i}.c
					#sed -i 's+/\* #include <math.h> \*/+#include <math.h>+' ./cetus_${FILE_NAME}.c
					#gcc -fopenmp -o output ./cetus_${FILE_NAME}.c -lm
					#mv output output${BENCH_CLASS}/cetus_${FILE_NAME}_reduction=1_${i}
					echo "<----------------------------->"
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS} -reduction=2 ${FILE_NAME}.c ../common/print_results.c ../common/randdp.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}_reduction=2_${i}.c
					#sed -i 's+/\* #include <math.h> \*/+#include <math.h>+' ./cetus_${FILE_NAME}.c
					#gcc -fopenmp -o output ./cetus_${FILE_NAME}.c -lm
					#mv output output${BENCH_CLASS}/cetus_${FILE_NAME}_reduction=2_${i}
					echo "<----------------------------->"
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS} -induction=0 ${FILE_NAME}.c ../common/print_results.c ../common/randdp.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}_induction=0_${i}.c
					#sed -i 's+/\* #include <math.h> \*/+#include <math.h>+' ./cetus_${FILE_NAME}.c
					#gcc -fopenmp -o output ./cetus_${FILE_NAME}.c -lm
					#mv output output${BENCH_CLASS}/cetus_${FILE_NAME}_induction=0_${i}
					echo "<----------------------------->"
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS} -induction=1 ${FILE_NAME}.c ../common/print_results.c ../common/randdp.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}_induction=1_${i}.c
					#sed -i 's+/\* #include <math.h> \*/+#include <math.h>+' ./cetus_${FILE_NAME}.c
					#gcc -fopenmp -o output ./cetus_${FILE_NAME}.c -lm
					#mv output output${BENCH_CLASS}/cetus_${FILE_NAME}_induction=1_${i}
					echo "<----------------------------->"
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS} -induction=2 ${FILE_NAME}.c ../common/print_results.c ../common/randdp.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}_induction=2_${i}.c
					#sed -i 's+/\* #include <math.h> \*/+#include <math.h>+' ./cetus_${FILE_NAME}.c
					#gcc -fopenmp -o output ./cetus_${FILE_NAME}.c -lm
					#mv output output${BENCH_CLASS}/cetus_${FILE_NAME}_induction=2_${i}
					echo "<----------------------------->"
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS} -induction=3 ${FILE_NAME}.c ../common/print_results.c ../common/randdp.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}_induction=3_${i}.c
					#sed -i 's+/\* #include <math.h> \*/+#include <math.h>+' ./cetus_${FILE_NAME}.c
					#gcc -fopenmp -o output ./cetus_${FILE_NAME}.c -lm
					#mv output output${BENCH_CLASS}/cetus_${FILE_NAME}_induction=3_${i}
					echo "<----------------------------->"
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS} -normalize-loops=0 ${FILE_NAME}.c ../common/print_results.c ../common/randdp.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}_normalize-loops=0_${i}.c
					#sed -i 's+/\* #include <math.h> \*/+#include <math.h>+' ./cetus_${FILE_NAME}.c
					#gcc -fopenmp -o output ./cetus_${FILE_NAME}.c -lm
					#mv output output${BENCH_CLASS}/cetus_${FILE_NAME}_normalize-loops=0_${i}
					echo "<----------------------------->"
			...
			for ((i=1; i<=${N_ITER}; i++))
				do
					${CETUS} -normalize-loops=1 ${FILE_NAME}.c ../common/print_results.c ../common/randdp.c ../common/c_timers.c ../common/wtime.c
					cp cetus_output/${FILE_NAME}.c cetus_${FILE_NAME}_normalize-loops=1_${i}.c
					#sed -i 's+/\* #include <math.h> \*/+#include <math.h>+' ./cetus_${FILE_NAME}.c
					#gcc -fopenmp -o output ./cetus_${FILE_NAME}.c -lm
					#mv output output${BENCH_CLASS}/cetus_${FILE_NAME}_normalize-loops=1_${i}
					echo "<----------------------------->"
