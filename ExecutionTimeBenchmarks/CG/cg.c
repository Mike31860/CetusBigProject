...
static int colidx[((1500000 * (21 + 1)) * (21 + 1))];
static int rowstr[(1500000 + 1)];
static int iv[1500000];
static int arow[1500000];
static int acol[(1500000 * (21 + 1))];
static double aelt[(1500000 * (21 + 1))];
static double a[((1500000 * (21 + 1)) * (21 + 1))];
static double x[(1500000 + 2)];
static double z[(1500000 + 2)];
static double p[(1500000 + 2)];
static double q[(1500000 + 2)];
static double r[(1500000 + 2)];
static int naa;
static int nzz;
static int firstrow;
static int lastrow;
...
#pragma event main #6 stop
	...
	printf("Time main_6 seconds %0.8f \n", time_diff(&start_main_6, &end_main_6));
...
#pragma event main #7 stop
		...
		printf("Time main_7 seconds %0.8f \n", time_diff(&start_main_7, &end_main_7));
	}
	return 0;
}
...
#pragma event conj_grad #0 stop
	...
	printf("Time conj_grad_0 seconds %0.8f \n", time_diff(&start_conj_grad_0, &end_conj_grad_0));
...
#pragma event conj_grad #1 stop
	...
	printf("Time conj_grad_1 seconds %0.8f \n", time_diff(&start_conj_grad_1, &end_conj_grad_1));
...
#pragma event conj_grad #2 stop
	...
	printf("Time conj_grad_2 seconds %0.8f \n", time_diff(&start_conj_grad_2, &end_conj_grad_2));
...
#pragma event conj_grad #3 stop
	...
	printf("Time conj_grad_3 seconds %0.8f \n", time_diff(&start_conj_grad_3, &end_conj_grad_3));
...
#pragma event conj_grad #4 stop
	...
	printf("Time conj_grad_4 seconds %0.8f \n", time_diff(&start_conj_grad_4, &end_conj_grad_4));
...
#pragma event makea #0 stop
	...
	printf("Time makea_0 seconds %0.8f \n", time_diff(&start_makea_0, &end_makea_0));
...
#pragma event sparse #0 stop
	...
	printf("Time sparse_0 seconds %0.8f \n", time_diff(&start_sparse_0, &end_sparse_0));
...
#pragma event sparse #1 stop
	...
	printf("Time sparse_1 seconds %0.8f \n", time_diff(&start_sparse_1, &end_sparse_1));
...
#pragma event sparse #2 stop
	...
	printf("Time sparse_2 seconds %0.8f \n", time_diff(&start_sparse_2, &end_sparse_2));
...
#pragma event sparse #3 stop
	...
	printf("Time sparse_3 seconds %0.8f \n", time_diff(&start_sparse_3, &end_sparse_3));
...
#pragma event sparse #4 stop
	...
	printf("Time sparse_4 seconds %0.8f \n", time_diff(&start_sparse_4, &end_sparse_4));
...
#pragma event sparse #5 stop
	...
	printf("Time sparse_5 seconds %0.8f \n", time_diff(&start_sparse_5, &end_sparse_5));
...
#pragma event sparse #6 stop
	...
	printf("Time sparse_6 seconds %0.8f \n", time_diff(&start_sparse_6, &end_sparse_6));
...
#pragma event sparse #7 stop
	...
	printf("Time sparse_7 seconds %0.8f \n", time_diff(&start_sparse_7, &end_sparse_7));
...
#pragma event sprnvc #0 stop
		...
		printf("Time sprnvc_0 seconds %0.8f \n", time_diff(&start_sprnvc_0, &end_sprnvc_0));
...
#pragma event vecset #0 stop
	...
	printf("Time vecset_0 seconds %0.8f \n", time_diff(&start_vecset_0, &end_vecset_0));
