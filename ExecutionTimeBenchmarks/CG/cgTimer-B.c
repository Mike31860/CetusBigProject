...
int main(int argc, char * argv[])
{
	...
	print_results("CG", Class, 75000, 0, 0, 75, t, mflops, "          floating point", verified, "3.3.1", "01 May 2023", "gcc", "$(CC)", "-lm", "-I../common", "-g -Wall -O3 -fopenmp -mcmodel=large", "-O3 -fopenmp -mcmodel=large", "randdp");
	if (timeron)
	{
		tmax=timer_read(1);
		if (tmax==0.0)
