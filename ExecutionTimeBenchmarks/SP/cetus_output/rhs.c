...
void compute_rhs()
{
	...
	time_spent15+=(((double)(end15-begin15))/((__clock_t)1000000));
	/* --------------------------------------------------------------------- */
	...
	time_spent16+=(((double)(end16-begin16))/((__clock_t)1000000));
	/* --------------------------------------------------------------------- */
	...
	time_spent17+=(((double)(end17-begin17))/((__clock_t)1000000));
	if (timeron)
	{
		timer_stop(2);
	}
	...
	time_spent18+=(((double)(end18-begin18))/((__clock_t)1000000));
	if (timeron)
	{
		timer_stop(3);
	}
	...
	time_spent19+=(((double)(end19-begin19))/((__clock_t)1000000));
	/* --------------------------------------------------------------------- */
