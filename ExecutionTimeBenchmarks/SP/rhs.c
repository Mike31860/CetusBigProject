...
void compute_rhs()
{
  ...
  for (k = 0; k <= grid_points[2]-1; k++) {
   ...
   clock_t end15 = clock();
  time_spent15 += (double)(end15 - begin15) / CLOCKS_PER_SEC;
  ...
  for (k = 0; k <= grid_points[2]-1; k++) {
   ...
   clock_t end16 = clock();
  time_spent16 += (double)(end16 - begin16) / CLOCKS_PER_SEC;
  ...
  clock_t end17 = clock();
  time_spent17 += (double)(end17 - begin17) / CLOCKS_PER_SEC;
  ...
  clock_t end18 = clock();
  time_spent18 += (double)(end18 - begin18) / CLOCKS_PER_SEC;
  ...
  clock_t end19 = clock();
  time_spent19 += (double)(end19 - begin19) / CLOCKS_PER_SEC;
